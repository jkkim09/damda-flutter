...
import 'package:damda/Screens/image.dart';
import 'package:damda/Screens/parameters.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (!_isLocationFound) {
      ...
      counterBloc.getCurrentLocation().then((_) {
        apiBloc.getWeatherData(
            counterBloc.getLatitude(), counterBloc.getLongitude());
      });
    }
